...
class ConfigSubConfigOutputHiddenStatesPropagationTest(unittest.TestCase):
    """`output_hidden_states=True` on a parent config should propagate to its sub-configs.

    Regression test for https://github.com/huggingface/transformers/issues/46382."""
